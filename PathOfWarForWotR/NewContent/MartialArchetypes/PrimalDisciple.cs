...
namespace TheInfiniteCrusade.NewContent.MartialArchetypes
{
    class PrimalDisciple
    {
        public static void Make()
        {
            ...
            primalDefine.MakeFullRecovery("Invoke Ancestral Strength", "In order for the primal disciple to recover maneuvers, she must draw on the strength of her ancestors as a full-round action. When she does so, she recovers a number of expended maneuvers equal to her primal disciple initiation modifier (minimum 2), regains one round of rage, and if she is fatigued as a result of her rage class feature, she can make a Fortitude save (DC 10 + the number of rounds the fatigue would last) to not become fatigued.");
            primalDefine.MakeStandardRecovery("Focus Inward", "A primal disciple may focus inward and recover a single maneuver as a standard action.");
