...
At 1st level, a judge gains a pool of ki points, supernatural energy he can use to accomplish amazing feats. The number of points in the judge’s ki pool is equal to 1/2 his stalker level + his Wisdom modifier (minimum of 1). Unless listed here, a judge’s ki pool abilities are the same as a normal stalker.
...
This replaces the stalker’s deadly strikes class feature. He may not select the deadly ambush, deadly insight, or deadly recovery stalker arts.
Domain

Like a cleric’s deity, a judge’s deity influences his alignment, what magic he can perform, and his values. Although not as tied to the tenets of the deity as a cleric, a judge must still hold such guidelines in high regard, despite that fact he can go against them if it serves the greater good of the faith. A judge can select one domain from among those belonging to his deity. He can select an alignment domain only if his alignment matches that domain. With the GM’s approval, a judge can be devoted to an ideal instead of a deity, selecting one domain to represent his personal inclination and abilities. The restriction on alignment domains still applies. Judges also have access to Inquisitions, which are similar to Domains but do not include Domain spells. If he so chooses, he may use an inquisition instead of a domain.
...
This replaces the stalker art gained at 3rd level.
Judge Arts
